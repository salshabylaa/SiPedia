...
<head>
    ...
    <style>
        ...
        .card {
            width: 100%;
            max-width: 400px;
            margin-top: 30px;  /* Mengurangi jarak antara navbar dan form */
            padding: 20px;
            border-radius: 10px;
...
<body>
    ...
    <div class="d-flex justify-content-center">
        <div class="card">
            <h1 class="mb-4 text-center">Login Dulu Yaa!</h1>
            <form action="plogin.php" method="POST">
                ...
                <button type="submit" name="login" class="btn btn-primary btn-custom w-100">Login</button>
            </form>
            <div class="text-center mt-3">
                <span>Belum Punya Akun? <a href="registrasi.html">Buat disini</a></span>
            </div>
        </div>
    </div>
    <br>
