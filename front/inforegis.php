...
<body>
    ...
    <div class="registration-box"><br><br><br><br><br><br><br><br>
        <h1 class="mb-4">Registrasi Berhasil!!, Akan beralih ke halaman login dalam <span id="countdown">5</span> detik.</h1>
