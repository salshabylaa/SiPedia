...
<body>
    ...
    <div class="form-container">
        <h2>Kontak Kami</h2>
        <form action="../back/page/kontak/ptkontak.php" method="POST">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="pesan" name="pesan" rows="4" placeholder="Ketikan Pesan, Saran, Dan Kritik" required></textarea>
            </div>
            <button type="submit" class="btn" onclick="alert('Pesan Terkirim! Terima Kasih')">Submit</button>
        </form>
    </div>
